      ...
      <div className='flex px-15 py-10'>
        <div className='w-[120%]'>
          ...
          <Image
            ...
            width={80}
            height={80}
            className='h-20 w-auto mt-2 ml-2 inline-block'
          />
        </div>
          ...
          >
            <div className='relative w-3/5'>
              ...
              <input
                ...
                className='w-full py-3 px-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-honey'
                value={email}
